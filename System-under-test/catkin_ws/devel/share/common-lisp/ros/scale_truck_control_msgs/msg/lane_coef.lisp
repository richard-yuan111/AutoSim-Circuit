...
(cl:defclass <lane_coef> (roslisp-msg-protocol:ros-message)
  ((left
    :reader left
    :initarg :left
    :type scale_truck_control_msgs-msg:lane
    :initform (cl:make-instance 'scale_truck_control_msgs-msg:lane))
   (right
    :reader right
    :initarg :right
    :type scale_truck_control_msgs-msg:lane
...
(cl:defmethod cl:initialize-instance :after ((m <lane_coef>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lane_coef)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scale_truck_control_msgs-msg:<lane_coef> is deprecated: use scale_truck_control_msgs-msg:lane_coef instead.")))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <lane_coef>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:left-val is deprecated.  Use scale_truck_control_msgs-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <lane_coef>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:right-val is deprecated.  Use scale_truck_control_msgs-msg:right instead.")
  (right m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <lane_coef>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:center-val is deprecated.  Use scale_truck_control_msgs-msg:center instead.")
  (center m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<lane_coef>)))
  ...
  (cl:format cl:nil "lane left~%lane right~%lane center~%~%================================================================================~%MSG: scale_truck_control_msgs/lane~%float32 c0  # a~%float32 c1  # b~%float32 c2  # c~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'lane_coef)))
  "Returns full string definition for message of type 'lane_coef"
  (cl:format cl:nil "lane left~%lane right~%lane center~%~%================================================================================~%MSG: scale_truck_control_msgs/lane~%float32 c0  # a~%float32 c1  # b~%float32 c2  # c~%~%~%"))

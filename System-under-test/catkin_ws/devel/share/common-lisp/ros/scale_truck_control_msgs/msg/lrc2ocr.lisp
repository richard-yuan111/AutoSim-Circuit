...
(cl:defmethod cl:initialize-instance :after ((m <lrc2ocr>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lrc2ocr)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scale_truck_control_msgs-msg:<lrc2ocr> is deprecated: use scale_truck_control_msgs-msg:lrc2ocr instead.")))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <lrc2ocr>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:index-val is deprecated.  Use scale_truck_control_msgs-msg:index instead.")
  (index m))
...
(cl:defmethod pred_vel-val ((m <lrc2ocr>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:pred_vel-val is deprecated.  Use scale_truck_control_msgs-msg:pred_vel instead.")
  (pred_vel m))

(cl:ensure-generic-function 'alpha-val :lambda-list '(m))
(cl:defmethod alpha-val ((m <lrc2ocr>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:alpha-val is deprecated.  Use scale_truck_control_msgs-msg:alpha instead.")
  (alpha m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lrc2ocr>)))
  ...
  "scale_truck_control_msgs/lrc2ocr")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lrc2ocr)))
  "Returns string type for a message object of type 'lrc2ocr"
  "scale_truck_control_msgs/lrc2ocr")

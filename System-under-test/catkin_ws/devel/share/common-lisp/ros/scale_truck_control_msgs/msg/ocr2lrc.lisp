...
(cl:defmethod cl:initialize-instance :after ((m <ocr2lrc>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ocr2lrc)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scale_truck_control_msgs-msg:<ocr2lrc> is deprecated: use scale_truck_control_msgs-msg:ocr2lrc instead.")))

(cl:ensure-generic-function 'cur_vel-val :lambda-list '(m))
(cl:defmethod cur_vel-val ((m <ocr2lrc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:cur_vel-val is deprecated.  Use scale_truck_control_msgs-msg:cur_vel instead.")
  (cur_vel m))

(cl:ensure-generic-function 'u_k-val :lambda-list '(m))
(cl:defmethod u_k-val ((m <ocr2lrc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control_msgs-msg:u_k-val is deprecated.  Use scale_truck_control_msgs-msg:u_k instead.")
  (u_k m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ocr2lrc>)))
  ...
  "scale_truck_control_msgs/ocr2lrc")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ocr2lrc)))
  "Returns string type for a message object of type 'ocr2lrc"
  "scale_truck_control_msgs/ocr2lrc")

...
(cl:defmethod cl:initialize-instance :after ((m <xav2lrc>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'xav2lrc)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scale_truck_control-msg:<xav2lrc> is deprecated: use scale_truck_control-msg:xav2lrc instead.")))
...
(cl:defmethod beta-val ((m <xav2lrc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control-msg:beta-val is deprecated.  Use scale_truck_control-msg:beta instead.")
  (beta m))

(cl:ensure-generic-function 'gamma-val :lambda-list '(m))
(cl:defmethod gamma-val ((m <xav2lrc>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control-msg:gamma-val is deprecated.  Use scale_truck_control-msg:gamma instead.")
  (gamma m))

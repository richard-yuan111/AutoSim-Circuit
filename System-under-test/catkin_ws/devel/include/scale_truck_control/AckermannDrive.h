// Generated by gencpp from file scale_truck_control/AckermannDrive.msg
// DO NOT EDIT!


#ifndef SCALE_TRUCK_CONTROL_MESSAGE_ACKERMANNDRIVE_H
#define SCALE_TRUCK_CONTROL_MESSAGE_ACKERMANNDRIVE_H
...
struct AckermannDrive_
{
  ...
  typedef boost::shared_ptr< ::scale_truck_control::AckermannDrive_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::scale_truck_control::AckermannDrive_<ContainerAllocator> const> ConstPtr;

}; // struct AckermannDrive_

typedef ::scale_truck_control::AckermannDrive_<std::allocator<void> > AckermannDrive;

typedef boost::shared_ptr< ::scale_truck_control::AckermannDrive > AckermannDrivePtr;
typedef boost::shared_ptr< ::scale_truck_control::AckermannDrive const> AckermannDriveConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::scale_truck_control::AckermannDrive_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::scale_truck_control::AckermannDrive_<ContainerAllocator1> & lhs, const ::scale_truck_control::AckermannDrive_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::scale_truck_control::AckermannDrive_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::scale_truck_control::AckermannDrive_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::scale_truck_control::AckermannDrive_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
{
  ...
  static const char* value(const ::scale_truck_control::AckermannDrive_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3512e91b48d69674ULL;
  static const uint64_t static_value2 = 0xa0e86fadf1ea8231ULL;
};

template<class ContainerAllocator>
struct DataType< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::scale_truck_control::AckermannDrive_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::scale_truck_control::AckermannDrive_<ContainerAllocator>& v)
  {
...
#endif // SCALE_TRUCK_CONTROL_MESSAGE_ACKERMANNDRIVE_H

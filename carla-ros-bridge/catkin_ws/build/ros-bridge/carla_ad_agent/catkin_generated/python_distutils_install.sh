...
echo_and_run cd "/home/krg/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_ad_agent"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/krg/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_ad_agent/setup.py" \
     \
    build --build-base "/home/krg/carla-ros-bridge/catkin_ws/build/ros-bridge/carla_ad_agent" \
    install \
    --root="${DESTDIR-/}" \

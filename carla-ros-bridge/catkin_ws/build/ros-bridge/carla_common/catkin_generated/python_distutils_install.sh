...
echo_and_run cd "/home/krg/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_common"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/krg/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_common/setup.py" \
     \
    build --build-base "/home/krg/carla-ros-bridge/catkin_ws/build/ros-bridge/carla_common" \
    install \
    --root="${DESTDIR-/}" \

...
(cl:defmethod cl:initialize-instance :after ((m <AckermannDrive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AckermannDrive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scale_truck_control-msg:<AckermannDrive> is deprecated: use scale_truck_control-msg:AckermannDrive instead.")))

(cl:ensure-generic-function 'steering_angle-val :lambda-list '(m))
(cl:defmethod steering_angle-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control-msg:steering_angle-val is deprecated.  Use scale_truck_control-msg:steering_angle instead.")
  (steering_angle m))
...
(cl:defmethod steering_angle_velocity-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control-msg:steering_angle_velocity-val is deprecated.  Use scale_truck_control-msg:steering_angle_velocity instead.")
  (steering_angle_velocity m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control-msg:speed-val is deprecated.  Use scale_truck_control-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control-msg:acceleration-val is deprecated.  Use scale_truck_control-msg:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'jerk-val :lambda-list '(m))
(cl:defmethod jerk-val ((m <AckermannDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scale_truck_control-msg:jerk-val is deprecated.  Use scale_truck_control-msg:jerk instead.")
  (jerk m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AckermannDrive>)))
  ...
  "scale_truck_control/AckermannDrive")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AckermannDrive)))
  "Returns string type for a message object of type 'AckermannDrive"
  "scale_truck_control/AckermannDrive")
